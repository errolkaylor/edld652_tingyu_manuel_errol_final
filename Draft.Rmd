...
# I couldn't get this line to work. On closer inspection, it seems the cloned data folder has this file in an iCloud format (.parquet.icloud), and this code is unable to read it. Maybe changing the format of the file would help.
...
#Again, this didn't work for me because there is no district_membership object in my environment
...
#The below codes also doesn't run on my system.
