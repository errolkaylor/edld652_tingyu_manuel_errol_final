...
Df %>% 
  ...
  theme_minimal()+
  labs(title = "Dual language immersion programs and English learners that scored at or above proficient in Oregon",
       x = "",
       y = "Avarage number of EL that scored at or above proficient",
       fill="")+
  theme(legend.title = element_text(size = 8))+
  guides(fill = "none")
